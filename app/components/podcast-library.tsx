...
export default function PodcastLibrary() {
  ...
  const start = useCallback(() => {
    ...
    void audio.play().catch((reason: unknown) => {
      ...
      setError("Playback could not start. Press Play again, or use Open audio to try the publisher’s file directly.");
    });
  }, []);
